...
int_wbb %>% 
  ...
  arrange(desc(count))
```
Spain, Australia and Canada are the countries that produce the most international women's college basketball players in the United States. They are well out in front, each with well over 100, and the next-closest nation doesn't even have 50.
...
Detroit Mercy has the most Spanish players on its roster than any other school. That's obvious from looking at the Titans' roster, which doesn't have any other international players outside Spain.
...
Portland has the most Australian players with seven. Looking at their roster, they have a handful of players from New Zealand as well. Big international pipeline there.
...
Simon Fraser, which is located in Vancouver, has the most Canadian players. That makes sense. It's interesting that no other school has more than two Canadians outside those top ones (VCU, Florida A&M, Hofstra and Robert Morris).
...
int_wbb %>% 
  ...
  arrange(desc(count))
```
As we saw different schools atop each of those lists, which are the ones that are overall bringing in the most international players? Simon Fraser's weird case is tied for the lead along with San Francisco, followed by Texas-Tyler and then Portland (see above), Rhode Island, VCU and Washington State. 